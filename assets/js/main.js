...
(function () {
  ...
  /* Resolve a ação de um botão (orçamento / aula / contato) */
  function aplicarAcao(el, acao) {
    if (acao === "orcamento") {
  ...
  function montar() {
    ...
    if (grade && C.servicos) {
      C.servicos.forEach(function (s, i) {
        ...
        var a = criar("a"); a.textContent = s.botao; aplicarAcao(a, s.acao);
    ...
    if (C.pinturaAoVivo) {
      ...
      preencherGaleria("#aovivo-galeria", pv.galeria, "assets/img/placeholder.svg");
    ...
    if (C.aulas) {
      ...
      var ab = $("#aulas-btn"); if (ab) { ab.textContent = au.botao; aplicarAcao(ab, au.acao); }
      preencherGaleria("#aulas-galeria", au.fotos, "assets/img/placeholder.svg");
    ...
    if (C.processo) {
      ...
      preencherGaleria("#processo-galeria", pr.fotos, "assets/img/placeholder.svg");
